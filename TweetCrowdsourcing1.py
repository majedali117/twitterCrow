...
def mainRunwithoutSparsity(annt_responses,nb_labels,row_csv,tweets_topics,groundTruth_temp):    
    ...
    row_csv.append(accuracy(trueLabels,groundTruth_temp,'inter-agreement with topics'))
    row_csv.append(accuracy(trueLabelsWithoutTopics,groundTruth_temp,'inter-agreement without topics'))
    #row_csv.append(accuracy(trueLabels_agree_rel,groundTruth_temp,'inter-agreement then reliability'))
    row_csv.append(accuracy(Kappa_trueLabelsWithoutTopics,groundTruth_temp,'Kappa without Topics'))
    row_csv.append(accuracy(Kappa_trueLabels,groundTruth_temp,'Kappa Topics'))
    #row_csv.append(accuracy(kappa_trueLabels_agree_rel,groundTruth_temp,'Kappa then reliability'))
    row_csv.append(accuracy(majority_voting,groundTruth_temp,'Majority Voting'))
    row_csv.append(accuracy(mv_withTopics,groundTruth_temp,'Majority Voting with Topics'))
    #row_csv.append(accuracy(rel_MV,groundTruth_temp,'Majority Voting then reliability'))
